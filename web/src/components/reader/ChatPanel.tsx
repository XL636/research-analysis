...
export default function ChatPanel({ messages, currentPage, isSending, onSend, onClear }: ChatPanelProps) {
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-primary-950">{t('reader.chatTitle')}</h3>
        </div>
        {messages.length > 0 && (
          <button
            onClick={handleClear}
