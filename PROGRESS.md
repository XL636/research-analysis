...
| 日期 | Task | 说明 |
|------|------|------|
| 2026-03-06 | T-89~98 | Phase 13 阅读辅助升级 — OpenAI/Claude 模型支持 + 引用标注 [p.X] + 文档概览 + 笔记系统 + 学习辅助 + 右侧 Tab 面板 |
| 2026-03-04 | T-88 | 测试体系改进 — respx 契约测试(17) + 冒烟测试(5) + 架构守护(4) + API 集成(7)，测试总数 198→231 |
| 2026-03-01 | T-87 | CrossRef 搜索源 + 中文数据库快捷链接（知网/万方/百度学术） |
...
| Reader Study Tools (学习指南/FAQ) | 18 | 全部通过 |
...
| M10: 测试体系改进 | 已完成 | respx 契约测试 + 架构守护 + API 集成 + 冒烟测试 |
| M11: 阅读辅助升级 | 已完成 | OpenAI/Claude 模型 + 引用标注 + 文档概览 + 笔记系统 + 学习辅助 + Tab 面板 |
